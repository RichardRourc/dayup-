            ...
            <span class="desc-tips-all">
                ...
                >
                    <div slot="content">
                        ...
                        <br />效的user_id
                        <br />
                        2. user_id合并规则：(1) 手机号相同，(2) 绑定了微信且微信渠道号相同，(3)
                        绑定了支付宝<br />且支付宝渠道号相同，(4)
        ...
        <div class="ball-wrap" :class="{ 'ball-wrap-disabled': disabled }">
            ...
            >
                <el-button
                    class="btn-preview"
                    :class="{
                        'btn-preview--disabled': disabled,
                        'btn-preview--disabled-init': disabled,
                    }"
